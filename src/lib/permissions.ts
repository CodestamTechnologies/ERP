...
export const canAccessRoute = (
  ...
  const routePermissionMap: Record<string, string> = {
    ...
    '/finance/reports': PERMISSIONS.FINANCE_REPORTS_VIEW,
    '/sales': PERMISSIONS.SALES_VIEW,
    '/sales/leads': PERMISSIONS.SALES_LEADS_MANAGE,
    '/sales/customers': PERMISSIONS.SALES_CUSTOMERS_MANAGE,
    ...
    '/inventory/suppliers': PERMISSIONS.INVENTORY_SUPPLIERS_MANAGE,
